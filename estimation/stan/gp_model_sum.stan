...
transformed parameters {
  ...
  matrix[n_elections, n_parties] election_trend_probabilities;
  ...
  profile("softmax") {
    ...
    matrix[n_elections, n_parties] elections_tmp = trend[election_layer1_idx,] + polling_error;
...
model {
  ...
  target += -1e3 * sum(columns_dot_product(election_y, election_trend_probabilities));
}
...
generated quantities {
  ...
  matrix[n_elections, n_parties] polling_error_distribution_at_observed;
  ...
  {
    matrix[n_elections, n_parties] elections_tmp = trend[election_layer1_idx,];
    matrix[n_elections, n_parties] elections_polling_error_tmp = trend[election_layer1_idx,] + polling_error;
